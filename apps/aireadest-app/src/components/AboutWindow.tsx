      ...
      {isOpen && (
        <div className='about-content flex flex-col gap-5 px-6 py-5'>
          <div className='flex flex-col items-center gap-3 text-center'>
            <Image src='/icon.svg' alt='AIReadest Logo' className='h-20 w-20' width={80} height={80} />
            <div className='select-text space-y-1'>
              <h2 className='text-2xl font-bold'>AIReadest</h2>
          ...
          <div className='bg-base-200 flex flex-col gap-3 rounded-2xl p-4 text-sm' dir='ltr'>
            <p className='text-base-content/80'>
              {_('AIReadest is an independent project based on Readest and OpenReadest.')}
            </p>
            <p className='text-base-content/80'>
              {_('Author: XuanYu-github. Based on Readest and OpenReadest.')}
            </p>
            <p className='text-base-content/80'>
              {_('License')}:{' '}
              <Link
