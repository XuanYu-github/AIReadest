...
Write-Host "[AIReadest] 启动本地 Web 调试服务 http://127.0.0.1:$Port"
...
Write-Host "[AIReadest] 启动 cloudflared 隧道"
...
Write-Host "[AIReadest] 本地服务 PID: $($devServer.Id)"
Write-Host '[AIReadest] cloudflared 窗口会输出 trycloudflare 地址，手机可直接打开测试。'
